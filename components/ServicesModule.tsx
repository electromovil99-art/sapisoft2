...
export const ServicesModule: React.FC<ServicesProps> = ({ services, products, categories, bankAccounts, onAddService, onFinalizeService, onMarkRepaired, clients, onAddClient, onOpenWhatsApp, locations }) => {
              ...
              <div className="flex flex-1 min-h-[380px]">
                  ...
                  <div className="flex-1 p-6 flex flex-col gap-5">
                      ...
                      <div className="space-y-4">
                          ...
                          <button onClick={handleAddPayment} className="w-full py-3.5 bg-slate-800 text-white rounded-2xl font-black flex items-center justify-center gap-2 shadow-xl hover:bg-slate-900 transition-all uppercase text-[11px] tracking-widest"><Plus size={18}/> Agregar Pago</button>
                      </div>
                  </div>
              </div>
                ...
                <div className="bg-white w-[280px] p-6 shadow-sm font-mono text-[10px] text-slate-800 relative">
                    ...
                    <div className="mt-12 flex flex-col items-center gap-4">
                        ...
                        <div className="w-full bg-slate-50 border border-slate-200 rounded-xl p-3 text-center space-y-1">
                            <p className="text-[10px] font-black uppercase text-slate-800 tracking-tight leading-none truncate">{ticketData.client}</p>
