...
import { Search, UserPlus, MessageCircle, Wallet, User, Phone, FileText, X, MapPin } from 'lucide-react';
                    ...
                    <div className="p-8 space-y-6">
                        ...
                        <div className="grid grid-cols-2 gap-6">
                            <div className="space-y-1">
                                ...
                                <input type="text" className="w-full p-3.5 bg-slate-50 dark:bg-slate-700 border border-slate-200 dark:border-slate-600 rounded-xl font-bold outline-none focus:border-primary-500 text-sm" value={newClientData.dni} onChange={e => setNewClientData({...newClientData, dni: e.target.value})} placeholder="00000000" />
                            </div>
                            <div className="space-y-1">
